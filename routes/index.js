...
router.post('/games/categories', function(req, res){
  ...
  if (action === 'game.1.start'){
    ...
    Category.find({}, function(err,data){
      ...
      var questions_g1 = [
        '<speak><audio src="https://calypso-catipus.herokuapp.com/audio/junk.wav">a cat meowing</audio>Thanks for helping meow-t! I found four things around the recycling plant. Can you help me categorize them? Here they are: a '+ gameData.items[0] +', a '+ gameData.items[1] +', a '+ gameData.items[2] +' and a '+ gameData.items[3] +'. What do these things have in common?</speak>',
        '<speak><audio src="https://calypso-catipus.herokuapp.com/audio/meow.wav">a cat meowing</audio>Today, while I was rummaging around the recycling plant, I found a few things that look pretty similar. Can you help me categorize them? The items I found are: a '+ gameData.items[0] +', a '+ gameData.items[1] +', a '+ gameData.items[2] +' and a '+ gameData.items[3] +'. What do you think these things have in common?</speak>',
        '<speak><audio src="https://calypso-catipus.herokuapp.com/audio/junk.wav">a cat meowing</audio>Help me categorize a few things. I’ll find some now! Let’s see ... (earcon: the sound of Calypso rummaging in a bin) I’ve got a '+ gameData.items[0] +', a '+ gameData.items[1] +', a '+ gameData.items[2] +', and a '+ gameData.items[3] +'. What category do you think these things belong to?</speak>',
        '<speak><audio src="https://calypso-catipus.herokuapp.com/audio/meow.wav">a cat meowing</audio>Let’s try categorizing these things: a '+ gameData.items[0] +', a '+ gameData.items[1] +', a '+ gameData.items[2] +', and a '+ gameData.items[3] +'. These four things are all types of what?</speak>',
        '<speak><audio src="https://calypso-catipus.herokuapp.com/audio/junk.wav">a cat meowing</audio>You’re the purrrrfect person to help me categorize these things: a '+ gameData.items[0] +', a '+ gameData.items[1] +', a '+ gameData.items[2] +' and a '+ gameData.items[3] +'. What category do all of these things belong to?</speak>',
        '<speak><audio src="https://calypso-catipus.herokuapp.com/audio/meow.wav">a cat meowing</audio>I find all kinds of things here at the recycling plant. You’ll never believe what I found today! I found a '+ gameData.items[0] +', a '+ gameData.items[1] +', a '+ gameData.items[2] +' and a '+ gameData.items[3] +'! What category do these things belong to?</speak>',
        '<speak><audio src="https://calypso-catipus.herokuapp.com/audio/junk.wav">a cat meowing</audio>My eight arms are all scratching my head on this one. Can you help me figure out what category these things belong to? They are: a '+ gameData.items[0] +', a '+ gameData.items[1] +', a '+ gameData.items[2] +' and a '+ gameData.items[3] +'. What do these things have in common?</speak>',
        '<speak><audio src="https://calypso-catipus.herokuapp.com/audio/meow.wav">a cat meowing</audio>This '+ gameData.items[0] +', this '+ gameData.items[1] +', this '+ gameData.items[2] +' and this '+ gameData.items[3] +' are all types of what?</speak>',
        '<speak><audio src="https://calypso-catipus.herokuapp.com/audio/junk.wav">a cat meowing</audio>What’s an eight-legged catipus to do!? I’ve found four things that I need help categorizing: a '+ gameData.items[0] +', a '+ gameData.items[1] +', a '+ gameData.items[2] +' and a '+ gameData.items[3] +'. What category do you think these four things have belong to</speak>',
        '<speak><audio src="https://calypso-catipus.herokuapp.com/audio/meow.wav">a cat meowing</audio>I’ll be your best friend if you can help me figure out what category '+ gameData.items[0] +'s, '+ gameData.items[1] +'s, '+ gameData.items[2] +'s and '+ gameData.items[3] +'s all belong to. What do you think they have in common?</speak>'
      ]; 
