...
router.post('/games/categories', function(req, res){
  ...
  if (action === 'game.1.start'){
    ...
    Category.find({}, function(err,data){
      ...
      var questions_g1 = [
        '<speak><audio src="https://calypso-catipus.herokuapp.com/audio/meow.wav">a cat meowing</audio>Thanks for helping meow-t! I found four things around the recycling plant. Can you help me categorize them? Here they are: a '+ gameData.items[0] +', a '+ gameData.items[1] +', a '+ gameData.items[2] +' and a '+ gameData.items[3] +'. What do these things have in common?</speak>',
        ...
        '<speak><audio src="https://calypso-catipus.herokuapp.com/audio/meow.wav">a cat meowing</audio>You’re the purrrrfect person to help me categorize these things: a '+ gameData.items[0] +', a '+ gameData.items[1] +', a '+ gameData.items[2] +' and a '+ gameData.items[3] +'. What category do all of these things belong to?</speak>',
        ...
        '<speak><audio src="https://calypso-catipus.herokuapp.com/audio/meow.wav">a cat meowing</audio>What’s an eight-legged catipus to do!? I’ve found four things that I need help categorizing: a '+ gameData.items[0] +', a '+ gameData.items[1] +', a '+ gameData.items[2] +' and a '+ gameData.items[3] +'. What category do you think these four things have belong to</speak>',
